...
- [x] Validação visual no navegador feita pelo usuário — cadastrar/editar/excluir/verificar um
      endpoint de verdade na sub-aba "Endpoints Externos" funcionou corretamente. Fase 5 fechada.
