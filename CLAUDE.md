...
- [**Plano: Verificar Acesso (Access Checker)**](ACCESS-CHECK-PLAN.md) ← ✅ CONCLUÍDA — checa acesso de analista via impersonation K8s + grupos AAD `VV_CLOUD_*` resolvidos por `az ad user get-member-groups` (sem Graph API)
