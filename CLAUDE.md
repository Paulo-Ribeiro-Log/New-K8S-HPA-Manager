...
`internal/web/handlers/nodepools_snat.go` + `SNATPortWidget.tsx` — diagnóstico do orçamento de portas SNAT do Load Balancer AKS. Exibido na barra de controles do `NodePoolTab` quando um cluster está selecionado.
