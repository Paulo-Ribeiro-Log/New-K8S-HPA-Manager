...
`CodeEditorTab.tsx` + `internal/web/handlers/code_editor.go` + `code_editor_terminal.go`: editor de código completo com integração Git/GitHub, acessível via Tools → "Editor de Código" (tela cheia). Fases 1-5 concluídas — ver `CODE-EDITOR-PLAN.md` para detalhes e Fase 6 planejada.
